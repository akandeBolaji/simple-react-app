...
export function* signUp({
	payload: { email, password, displayName, dob, address, photo, security1, security2, security3},
}) {
	try {
		...
		yield put(
			signUpSuccess({
				user,
				additionalData: { displayName, dob, address, photo, security1, security2, security3 },
			})
		);
